...
- In (exec)
- Target (object)
- Static Meshes (object) — Set of Static mesh to add convex collision on.
...
**Description:** Compute convex collisions for a set of static meshes. Any existing collisions will be removed from the static meshes. This method replicates what is done when invoking menu entry "Collision > Auto Convex Collision" in the Mesh Editor.
---
