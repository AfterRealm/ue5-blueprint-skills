...
- In (exec)
- Target (object)
- Static Mesh (object) — Static mesh to check if its section affects distance field lighting.
...
**Description:** Checks if a specific LOD mesh section affects distance field lighting.
---
