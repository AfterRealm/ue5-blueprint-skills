...
- In (exec)
- Target (object)
- Delta Transform (transform) — Change in transform in world space for the component. Scale is ignored.
...
**Description:** Adds a delta to the transform of the component in world space. Ignores scale and sets it to (1,1,1).
---
