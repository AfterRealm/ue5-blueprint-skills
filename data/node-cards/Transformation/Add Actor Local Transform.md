...
- In (exec)
- Target (object)
- New Transform (transform) — The change in transform in local space.
...
**Description:** Adds a delta to the transform of this component in its local reference frame
---
